...
function TableComponent() {
  ...
  console.log('trackingContext table data: ', trackingContext.tableData);
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            return (<tr key={trackinElement.id}>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                {trackinElement.id}
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <div onClick={() => handleTrackingClick(trackinElement.id)} className="inline-block cursor-pointer bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium hover:bg-blue-200 transition-colors">
